...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "陞煇食品 內部管理平台" },
      { name: "description", content: "陞煇食品內部管理平台" },
      { property: "og:title", content: "陞煇食品 內部管理平台" },
      { property: "og:description", content: "陞煇食品內部管理平台" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/favicon_512.png" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "陞煇食品 內部管理平台" },
      { name: "twitter:description", content: "陞煇食品內部管理平台" },
      { name: "twitter:image", content: "/favicon_512.png" },
    ],
    links: [
